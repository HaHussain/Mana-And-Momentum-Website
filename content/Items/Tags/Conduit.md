...
Conduit Equipment may have a listed set of [[Elements]], during a [[Rules/Resting/index|Rest]], the [[Rules/Characters/index|Character]] wielding it may set the element of the Conduit to one of those types. The item gains the tag of the selected Element.
When an [[Consumables#Affluent|Affluent]] is applied to a Conduit Item, this can change the type if it is in the set of Elements listed for that Conduit.
