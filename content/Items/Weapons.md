...
| ------------ | ------ | ------------------------------ | --------------------------------- | ------------------------------------------------------------------- |
| Dagger       | Small  | Melee,<br>One-Handed,<br>Quick | Can use in grapple without issues | Apply a [[- Debuff\|Debuff]] from a list?<br>Increased crit chance? |
...
| Pistol      | Medium | Ranged,<br>One-Handed,<br>Slow |                |                |
| Longbow     | Medium | Ranged,<br>Two-Handed          |                |                |
| Rifle       | High   | Ranged,<br>Two-Handed,<br>Slow | Same as Pistol | Same as Pistol |
| Crossbow    | Medium | Ranged,<br>Two-Handed          | Armour Pierce  |                |
| Hand-Cannon | Large  | Ranged,<br>Two-Handed,<br>Slow |                | Splash Damage  |
