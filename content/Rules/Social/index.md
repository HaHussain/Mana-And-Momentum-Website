...
In general the social ruleset kicks in when players decide to convince someone to do something that goes beyond a simple [[Rules/Characters/Skills/index|Skill]] [[Rules/Rolls/index|roll]]. First the [[GM]] sets a difficulty from -2 to 2 - which depends on the character's opinions and values, and adds this to the [[Rules/Characters/index|Characters]] [[Resolve]]. (Or comes up with a single value that is the sum of those two things).
