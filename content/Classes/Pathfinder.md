...
# Custom Trigger
Choose 1 of:
- When the Pathfinder provides information by separately scouting ahead, gain 1d4 [[Momentum]].
- When the Pathfinder plans, sets, or performs an ambush, gain 1d4 [[Momentum]].
- When the Pathfinder discovers a new location or route, or travels through uncharted ground, gain 1d4 [[Momentum]].
...
When the Pathfinder applies [[Marked]], the action gains the [[Curse]] tag, it lasts for an hour, and they can spend a [[Momentum]] to apply [[Marked]] to a [[Rules/Characters/index|Character]] or [[Object]] they, or their [[#Animal Companion|Companion]] has seen before, if they do, it lasts for a day.
...
- Mounts?
- Reaction move away from someone
