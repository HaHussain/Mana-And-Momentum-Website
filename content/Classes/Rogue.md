...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tempo:**   | 1                                                                                                                                                                                           |
| **Trigger:** | You kill an [[Isolated]] [[Rules/Characters/index\|Character]]                                                                                                                              |
...
- When you [[Critical Strike|Crit]] against a non-[[Elite]] enemy outside of combat, they die.
- While [[Attack|Attacking]] with a [[Quick]] weapon make +1 [[Strike|Strikes]].
- [[Weapons|Weapon]] Focus 1 on [[Quick]].
...
- You may attempt to [[Hide]] while in [[Line of Sight]] of [[Rules/Characters/index|Characters]] as long as you are outside of their [[Seek]]. 
  Roll a [[Dexterity]] [[Infiltrate]] check, for every 5 you exceed on a Stealth roll, you may ignore the [[Line of Sight]] of one of these [[Rules/Characters/index|Characters]].
- You may [[Hide]] within a [[Rules/Characters/index|Characters]] [[Seek]] if they
- When the Rogue [[Exert|Exerts]] to have a flashback, reduce the [[Exert#Exertion|Exertion]] gained by 1 (minimum 1).
- When you would disarm a [[Rules/Characters/index|Character]], you can instead choose to steal that item.

|             | Pilfer                                                 |
| ----------- | ------------------------------------------------------ |
| **Tempo:**  | 7                                                      |
| **Target:** | 1 [[Rules/Characters/index\|Character]] in [[Range]] 1 |
| **Action:** | Steal 1 [[Item Points\|Item Point]]                    |
| **Tags:**   | [[Rules/Actions/index\|Action]]                        |

- When the Rogue steals a [[Consumables|Consumable]] they can immediately use it.
- When the Rogue uses a [[Consumables|Consumable]] they can ignore all of its effects until the end of the Round.
